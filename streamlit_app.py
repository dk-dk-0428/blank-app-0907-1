...
# 이미지 크기 선택
size_options = {"1024x1024 (정사각형)": "1024x1024", "1792x1024 (가로형)": "1792x1024", "1024x1792 (세로형)": "1024x1792"}
selected_size_label = st.selectbox("이미지 크기를 선택하세요:", list(size_options.keys()))
